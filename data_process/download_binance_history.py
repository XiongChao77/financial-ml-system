...
OUTPUT_COLUMNS = [
    "open_time_ms", "open_time_dt_utc", "open", "high", "low", "close", "volume",
    "number_of_trades", "close_time_utc", "quote_asset_volume", 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--interval", default="1m") #e.g., "1h" – supported intervals: 1s, 15s, 1m, 3m, 5m, 15m, 30m, 1h, 2h, 4h, 6h, 8h, 12h, 1d, 3d, 1w, 1M
