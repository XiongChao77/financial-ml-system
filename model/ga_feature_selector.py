...
from Quant.model import train_old
...
def train_worker(result_queue, sub_config_list, data_cfg, train_cfg, model_cfg):
    ...
    try:
        ...
        # 运行训练
        metrics = train_old.run_training(
            sub_config_list, 
            worker_logger, 
            data_cfg, 
            train_cfg, 
