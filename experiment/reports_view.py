...
def main():
    ...
    # exit()
    stats, f_map, groups = analyze_holdbar(sorted_selected1,target_key="stride",period ='long', metric_key="cagr")
    ...
    analyze_holdbar(selected,target_key="vol_multiplier_long", period ='long',metric_key="cagr")
